    ...
    return (
		show && (
			<div className={`modal-root`}>
				...
				<div
					className={`modal-container ${!active ? `modal-hidden` : ``} ${
						motionEnabled
							? motion === `fade`
								? `${`modal-fade`}`
					...
					<div className={`modal`}>
						{active ? (
							<div
								...
								<Dialog.Body>{children && (utils.val.isValidArray(children, true) || utils.val.valIsValid(children)) && children}</Dialog.Body>
