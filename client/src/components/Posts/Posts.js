...
/*
                <div className="input-group input-group-inline">
                    <label
                        ...
                        htmlFor={`posts-number-input-setpagenum`}>
                        Page #
                    </label>
                    <input
                        type="number"
                        className={`input-group-field input-field-number`}
                        name={`posts-number-input-setpagenum`}
                        key={`posts-number-input-setpagenum`}
                        id={`posts-number-input-setpagenum`}
                        defaultValue={pageIndex}
                        onChange={(event) => {
                ...
                <div className="input-group input-group-inline">
                    <input
                        type="number"
                        className={`input-group-field input-field-number`}
                        name={`posts-number-input-setpagelength`}
                        key={`posts-number-input-setpagelength`}
                        id={`posts-number-input-setpagelength`}
                        defaultValue={pageLength}
                        onChange={(event) => {
                    ...
                    <label
                        className="input-group-label"
                        htmlFor={`posts-number-input-setpagelength`}>
                        of {data.length % pageLength}
                    </label>
*/
